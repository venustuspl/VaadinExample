...
@Component
public class DateList extends Composite implements View {
    ...
    public void init() {
        ...
        carGrid.addColumn((ValueProvider<Car, Object>)
                car -> new ExternalResource(car.getPictureLink())).setCaption("Picture")
                .setRenderer(new ImageRenderer()).setResizable(true);
        carGrid.addColumn(Car::getDateTime).setCaption("Date");
